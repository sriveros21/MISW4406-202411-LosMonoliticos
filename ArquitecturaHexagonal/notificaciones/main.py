...
consumer = client.subscribe('eventos-auditoria', consumer_type=_pulsar.ConsumerType.Shared, subscription_name='sub-notificacion-eventos-audtorias', schema=AvroSchema(EventoAuditoriaCreada))
