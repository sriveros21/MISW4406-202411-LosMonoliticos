...
from PropiedadesdelosAlpes.propiedades.seedwork.aplicacion.comandos import Comando
from PropiedadesdelosAlpes.propiedades.seedwork.dominio.eventos import EventoDominio
