...
from PropiedadesdelosAlpes.modulos.propiedades.dominio.objetos_valor import EstadoPropiedad, Nombre, Piso, TipoPropiedad 
...
class MapeadorPropiedades(Mapeador):
    ...
    def map_ubicacion_dto_to_domain(self, ubicacion_dto: UbicacionDTO) -> UbicacionVO:
        return UbicacionVO(
            latitud=ubicacion_dto.latitud,
            longitud=ubicacion_dto.longitud,
        )

    def map_dimension_dto_to_domain(self, dimension_dto: DimensionDTO) -> DimensionVO:
        return UbicacionVO(
